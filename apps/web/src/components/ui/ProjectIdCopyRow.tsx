...
/**
 * Shows the project UUID with a copy button (for CLI `FORETRACE_PROJECT_ID`).
 */
export function ProjectIdCopyRow({
  projectId,
  className = '',
}: {
  ...
  return (
    ...
    >
      ...
      <p className="mt-1.5 text-[10px] leading-snug text-zinc-500 dark:text-zinc-400">
        Use as <span className="font-mono">FORETRACE_PROJECT_ID</span> for the CLI /
        terminal ingest.
      </p>
    </div>
  );
