  ...
  return (
    <main>
      <PageHeader
        eyebrow="Workspace"
        title="Projects"
        description="Create delivery workspaces, connect GitHub, and roll up risk across teams. This screen is wired for navigation—data lands when the projects API is connected."
        meta={
          <Link
            to="/"
      ...
      <div className="animate-rise rounded-2xl border border-dashed border-zinc-300/90 bg-white/80 p-10 text-center shadow-sm dark:border-zinc-700/90 dark:bg-zinc-900/40">
        ...
        <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          You’re on a real route at <code className="rounded bg-zinc-100 px-1.5 py-0.5 text-xs dark:bg-zinc-800">/projects</code>.
          When the backend is ready, this grid will list organizations, default branches, and delivery health.
        </p>
        <button
          type="button"
          disabled
          title="Provisioning flow ships with authentication"
